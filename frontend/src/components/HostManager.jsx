...
// ⚡ Bolt: Memoize HostRow to prevent O(N) DOM re-renders when mapping over large lists of hosts.
const HostRow = React.memo(({ host, isEditing, editForm, setEditForm, onStartEdit, onSaveEdit, onCancelEdit, onDelete }) => {
    return (
