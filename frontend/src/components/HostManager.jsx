...
// ⚡ Bolt: Memoized HostRow prevents O(N) DOM re-renders when mapping over the hosts list.
// By selectively passing editForm and ensuring callbacks are stable via useCallback,
// we prevent unmodified rows from re-rendering when the user types in the edit form.
                ...
                <>
                    ...
                    <td className="p-3 text-right align-top">
                        <div className="flex gap-2 justify-end">
                            <button onClick={() => onSave(host.id, editForm)}
                            ...
                            {hosts.length === 0 ? (
                                ...
                                hosts.map((host) => (
                                    <HostRow
                                        ...
                                        setEditForm={editingHost === host.id ? setEditForm : null}
                                        onSave={saveEdit}
                                        onCancel={cancelEdit}
                                        onEdit={startEdit}
