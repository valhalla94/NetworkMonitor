...
// ⚡ Bolt: Extracted HostRow component wrapped in React.memo prevents O(N) DOM re-renders
// when editing a single row or when HostManager state (like showAddPanel) changes.
