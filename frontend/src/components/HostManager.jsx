...
// ⚡ Bolt: Extracted and memoized HostRow to prevent O(N) DOM re-renders of the entire list when a single row is edited
const HostRow = memo(({ host, isEditing, editForm, setEditForm, onSaveEdit, onCancelEdit, onStartEdit, onDelete }) => (
            ...
            <>
                ...
                <td className="p-3 text-right align-top">
                    <div className="flex gap-2 justify-end">
                        <button onClick={() => onSaveEdit(host.id)}
                                ...
                                hosts.map((host) => {
                                    ...
                                    return (
                                        <HostRow
                                            ...
                                            setEditForm={isEditing ? setEditForm : undefined}
                                            onSaveEdit={isEditing ? () => saveEdit(host.id, editForm) : undefined}
