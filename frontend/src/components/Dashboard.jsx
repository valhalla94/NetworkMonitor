...
// Prevents O(n) host cards from re-rendering every time the dashboard parent state updates
// (e.g. during frequent metrics polling, quick ping changes, or chart toggles).
// We pass the stable `setSelectedHost` as `onSelect` instead of an inline arrow function
// to preserve React.memo's shallow prop equality check.
