...
// ⚡ Bolt: Memoized HostCard component to prevent unnecessary re-renders
// By passing a stable `onSelect` reference and primitive `isSelected`,
// we avoid passing inline arrow functions that break React.memo's shallow equality checks.
