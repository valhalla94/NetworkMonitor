...
// ⚡ Bolt: Extracted HostCard component and wrapped with React.memo
// This prevents unnecessary re-renders of the host card list items during unrelated state updates
// (like timeRange changes, SSE updates for other hosts, etc.).
// By passing the stable `setSelectedHost` function as `onSelect` and handling the host argument internally,
// we preserve shallow equality and prevent reference-breaking inline arrow functions.
// Expected Impact: Reduces main-thread blocking time during high-frequency updates on dashboards with many hosts.
