...
// ⚡ Bolt: Extracted HostCard and wrapped in React.memo
// This prevents O(N) DOM re-renders of the entire host list every time unrelated state
// (like timeRange, metrics, networkStatus, etc.) changes. Since selectedHost is the only
// host-specific state changing, passing isSelected avoids re-rendering unselected cards.
