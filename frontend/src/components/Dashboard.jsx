...
// ⚡ Bolt: Extracted HostCard into a memoized component.
// This prevents unnecessary re-renders of the entire host list (which can be large)
// when unrelated state in Dashboard changes (like chart metrics, time ranges, or quick ping).
// We pass setSelectedHost directly as onSelect because state setters have a stable reference.
