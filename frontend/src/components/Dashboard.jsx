...
// ⚡ Bolt: Extract and memoize the HostCard component.
// Passing the `onSelect` prop explicitly ensures that if a stable reference (like a raw setter)
// is passed down, the component won't re-render unless its own `host` or `isSelected` prop changes.
