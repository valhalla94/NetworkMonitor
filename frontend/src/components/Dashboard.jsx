        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            {groupNames.map(groupName => (
                <div key={groupName} className="mb-4">
                    ...
                    {/* ⚡ Bolt: Using the memoized HostCard prevents re-rendering all list items on every SSE hosts_update if they haven't changed.
                        Passing setSelectedHost directly (a stable reference) instead of an inline arrow function avoids breaking the shallow equality check. */}
