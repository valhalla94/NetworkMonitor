...
def export_metrics_csv(
    ...
    # ⚡ Bolt: Write directly to a temporary file using batch fetches instead of loading all rows into memory
    # This prevents severe memory bottlenecks when exporting large datasets over long periods (like -30d or -1y)
    ...
    try:
        ...
        # Fetch results in batches to save memory
