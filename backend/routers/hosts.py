...
def export_metrics_csv(
    ...
    # ⚡ Bolt: Use yield_per(1000) and generator to stream large CSV exports.
    # Impact: Prevents massive memory spikes and OOM crashes when exporting 1-year telemetry data,
    # as we no longer fetch and buffer the entire dataset in RAM before sending the response.
    def iter_csv():
        output = io.StringIO()
